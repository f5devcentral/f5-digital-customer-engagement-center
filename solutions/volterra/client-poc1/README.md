...
| sharedVpcs | The shared VPCs with common services like security, firewall, load balancing, and more. | <pre>map(object({<br>    cidr                   = string<br>    public_subnets         = list(any)<br>    private_subnets        = list(any)<br>    volterra_inside_subnet = string<br>  }))</pre> | <pre>{<br>  "hub": {<br>    "cidr": "100.64.0.0/20",<br>    "private_subnets": [<br>      "100.64.3.0/24"<br>    ],<br>    "public_subnets": [<br>      "100.64.0.0/24"<br>    ],<br>    "volterra_inside_subnet": "100.64.6.0/24"<br>  }<br>}</pre> | no |
| spokeVpcs | The spoke VPCs with applications. | <pre>map(object({<br>    cidr            = string<br>    public_subnets  = list(any)<br>    private_subnets = list(any)<br>    workstation     = bool<br>  }))</pre> | <pre>{<br>  "bu1": {<br>    "cidr": "10.1.0.0/16",<br>    "private_subnets": [<br>      "10.1.52.0/24"<br>    ],<br>    "public_subnets": [<br>      "10.1.10.0/24"<br>    ],<br>    "workstation": true<br>  },<br>  "bu2": {<br>    "cidr": "10.2.0.0/16",<br>    "private_subnets": [<br>      "10.2.52.0/24"<br>    ],<br>    "public_subnets": [<br>      "10.2.10.0/24"<br>    ],<br>    "workstation": false<br>  }<br>}</pre> | no |
